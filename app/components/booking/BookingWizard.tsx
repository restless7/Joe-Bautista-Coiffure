            ...
            <Transition show={isOpen} as="div">
                <Dialog onClose={onClose} className="relative z-50">
                    ...
                    <div className="fixed inset-0 flex items-center justify-center p-4">
                        <DialogPanel className="w-full max-w-md bg-white rounded-2xl p-8 text-center shadow-2xl">
        ...
        <Transition show={isOpen} as="div">
            <Dialog onClose={onClose} className="relative z-50">
                ...
                <div className="fixed inset-0 flex items-end md:items-center justify-center p-0 md:p-4">
                    ...
                    >
                        <DialogPanel className="w-full max-w-2xl bg-white rounded-t-3xl md:rounded-2xl shadow-2xl overflow-hidden flex flex-col max-h-[90vh]">
                            {/* Header */}
